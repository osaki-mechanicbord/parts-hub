...
<aside class="w-64 bg-white shadow-lg min-h-screen">
    <nav class="p-4">
        ...
        <a href="/admin/inquiries" class="flex items-center px-4 py-3 mb-2 ${currentPage === 'inquiries' ? 'bg-red-50 text-red-600' : 'text-gray-700 hover:bg-gray-50'} rounded-lg">
            <i class="fas fa-envelope w-5"></i>
            <span class="ml-3 ${currentPage === 'inquiries' ? 'font-medium' : ''}">問い合わせ管理</span>
        </a>
