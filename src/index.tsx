        ...
        <div class="submit-footer">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mt-1.5">
                    <span class="text-xs text-gray-400">出品手数料は販売時に10%のみ（購入者負担なし）</span>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-8 space-y-6">
                ...
                <section class="border-b border-gray-200 pb-4">
                    ...
                    <div class="space-y-2 text-gray-700">
                        <p><strong>販売手数料（出品者負担）：</strong>商品価格（税抜）の10%（購入者のサービス手数料は無料です）</p>
    ...
    <head>
        ...
        <script type="application/ld+json">
        {
          ...
          "mainEntity": [{
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "販売手数料は商品価格の10%（出品者負担）です。振込手数料は売上金の出金時に200円かかります。購入者のサービス手数料は無料で、商品代金と配送料のみで購入できます。"
            }
          },{
            "@type": "Question",
